public class B4_MiltonFilter extends World
{
   ...
   public void go()
   {
      plane.loadBackGround("eye2.jpg");          //*** new method to load a diffrent JPG
      System.out.println("This will be printed to the  window. ");
      plane.teleport(0,0);
      plane.showBackGround();                    
      System.out.println(plane.howMuchRed());         
   
      for(int row=10; row<135; row++)    //*** this is using new getBackground
      {
         for(int col=70; col<160; col++)    //*** this is using new getBackgroun
         {
...
//            }
            ...
            if((red>200 && green>=0 && blue>=0) && (red<=255 && green<80 && blue<80))
            {
